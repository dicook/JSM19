...
.green[*"Although well provided with distinguishing characteristics, Iris versicolor and Iris virginica seem to be under a special curse so far as their recognition in the herbarium is concerned."*] [Anderson, 1936 The Species Problem in Iris](https://http://biostor.org/reference/11559)
...
- What does it mean to use the iris, and how to get into de-tox treatment
...
.pull-left[
`r anicon::nia("Would you like to grow your own irises? ", anitype="hover", color="#686CA9", speed="slow")` 
...
*People have been using this data for demonstrating supervised classification for almost 100 years!*
